	...
	window.lumise = {
		...
		objects : {
			...
			events : {
				...
				'object:rotating': function(opts){
					...
					lumise.get.el('rotate').val(opts.target.angle).attr({'data-value': Math.round(opts.target.angle)+'Âº'});
				},
		...
		fn : {
			...
			slugify : function(text) {
			  ...
			  var a = 'Ã Ã¡áº¡Ã¤Ã¢Ã£áº¥áº§áº«áº­áº¡Äƒáº¯áº±áºµáº·Ã¨Ã©Ã«Ãªáº¿á»á»…áº¹á»‡Ã¬Ã­Ä©Ã¯Ã®á»‹Ã²Ã³Ã¶Ã´á»‘á»“á»—á»™á»Ã¹ÃºÃ¼Ã»Å©á»¥Ã¹ÃºÅ©Ä‘Ã±Ã§ÃŸÃ¿Å“Ã¦Å•Å›Å„á¹•áºƒÇµÇ¹á¸¿Ç˜áºÅºá¸§Â·/_,:;',
